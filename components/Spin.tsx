...
export function Spin(props: SVGProps<SVGSVGElement>) {
  return (
    <div style={{ textAlign: 'center', display: "flex", alignItems: 'center', justifyContent: 'center', alignSelf: 'center',  gap: "10px", padding: '20px' }} 
    className='m-40'
    >
      <svg
      ...
      <div style={{ marginTop: '10px', fontSize: '16px', color: 'white' }}>
        Loading 
      </div>
    </div>
  );
